...
try:
    from atlas_email.utils.regex_optimizer import regex_optimizer, get_pattern, check_domain_fast
...
class DomainValidator:
    ...
    def validate_domain_before_deletion(self, sender_email, subject):
        ...
        # Don't automatically preserve emails just because domain "looks normal"
        # Only protect explicitly whitelisted legitimate domains
        # Let ML spam classification make the decision for other domains
        return True, "Domain analysis complete - defer to ML classification", False
