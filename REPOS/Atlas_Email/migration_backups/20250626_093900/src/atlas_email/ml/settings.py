...
from config.constants import ML_DEFAULT_SETTINGS, ML_SETTINGS_FILE
from atlas_email.utils.general import (
...
class CategoryManager:
    ...
    def _get_category_risk_level(self, category: str) -> str:
        ...
        from config.constants import HIGH_RISK_CATEGORIES, MEDIUM_RISK_CATEGORIES, RISK_LEVELS
...
class RealTimeTestManager:
    ...
    def _test_single_email(self, subject: str, sender: str) -> None:
        ...
        from atlas_email.core.spam_classifier import classify_spam_type
