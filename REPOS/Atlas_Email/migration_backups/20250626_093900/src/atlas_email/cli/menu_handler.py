...
import sys
from atlas_email.utils.general import get_user_choice as get_single_choice
...
def show_user_guide():
    ...
    from atlas_email.utils.general import display_application_header, clear_screen
