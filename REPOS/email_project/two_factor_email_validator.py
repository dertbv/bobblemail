...
import re
from legitimate_business_prefixes import is_legitimate_business_prefix, get_prefix_confidence_explanation
from domain_validator import DomainValidator, is_gibberish_email, detect_provider_from_sender
...
class TwoFactorEmailValidator:
    ...
    def validate_email_classification(self, sender_email, subject, email_content=""):
        ...
        from spam_classifier import is_transactional_email, is_account_notification, is_subscription_management
